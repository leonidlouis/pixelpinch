...
// Optimized: Memoized to prevent re-renders when parent state updates (e.g. file progress)
export const DropZone = memo(function DropZone({ onFilesAdded, disabled }: DropZoneProps) {
